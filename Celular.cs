...
namespace Leccion2doParcial
{
    ...
    public celular(int IMEI, string Marca, string Modelo, string Sistema, string Pais, string funcionalidad1, string funcionalidad2, string funcionalidad3) : base(IMEI, Marca, Modelo, Sistema, Pais, funcionalidad1, funcionalidad2, funcionalidad3)
    { 
